...
$azureSearchApiKey = azd env get-value AZURE_SEARCH_API_KEY
...
Add-Content -Path $envFilePath -Value "AZURE_OPENAI_CHAT_DEPLOYMENT=$azureOpenAiChatDeployment"
...
Add-Content -Path $envFilePath -Value "AZURE_SEARCH_API_KEY=$azureSearchApiKey"
